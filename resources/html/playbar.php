<div id="player-bar">
    <div class="song-info">
        <img id="player-image" src="" alt="Song Image">
        <span id="player-title" class="song-title"></span>
    </div>
    <div class="controls">
    ...
    <div id="youtube-player"></div> <!-- Ensure this is present -->
</div>
...
<style>
    ...
    #player-bar .extra-controls button {
        background: none;
        border: none;
        color: #b3b3b3;
        font-size: 16px;
    ...
    #player-bar .extra-controls button:hover {
        color: #fff;
    }
    #youtube-player {
        display: none;
